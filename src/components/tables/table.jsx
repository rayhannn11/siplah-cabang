                                    ...
                                    <tr key={row.id}>
                                        {row.getVisibleCells().map((cell) => {
                                            ...
                                            if (columnId === "status_name") {
                                                const statusConf =
                                                    tableStyleMapping.cell.status_name;
                                                return (
                                                    <td
                                                        key={cell.id}
                                                        className={`border-t border-b border-[#DEE2E6] px-3 py-2 text-center ${tdClass}`}
                                            ...
                                            if (columnId === "approve") {
                                                const approveConf =
                                                    tableStyleMapping.cell.approve;
                                                return (
                                                    <td
                                                        key={cell.id}
                                                        className={`border-t border-b border-[#DEE2E6] px-3 py-2 text-center ${tdClass}`}
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        {Array.from(
                            ...
                            if (
                                ...
                                const isActive =
                                    tableConfig?.pagination.currentPage === p;
                                return (
                                    <button
                                        key={p}
