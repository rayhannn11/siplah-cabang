...
import { fetchEurekaPaymentReport, fetchEurekaPaymentSummary } from "../../api";
...
const PaymentEureka = () => {
    ...
    const fetchSummary = async () => {
        try {
            ...
            const response = await fetchEurekaPaymentSummary({
                startDate: filters.startDate,
                endDate: filters.endDate,
                no_invoice: filters.no_invoice,
            });

            console.log("Summary response:", response);
            setSummaryData(response.data?.summary || response.data);
        } catch (err) {
            console.error("Error fetching Eureka payment summary:", err);
    ...
    return (
        <div className="p-4 mb-10">
            ...
            <div className="flex justify-between items-center mb-6">
                <h1 className="text-3xl font-semibold dark:text-black">Tagihan Eureka</h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        <div>
                            ...
                            <p className="text-2xl font-bold">
                                {summaryData.het_total_formatted || "Rp 0"}
                            </p>
                        </div>
                        <div>
                            <p className="text-sm opacity-90">Total NONSIBI</p>
                            <p className="text-2xl font-bold">
                                {summaryData.nonhet_total_formatted || "Rp 0"}
                            </p>
                        </div>
                        <div>
                            <p className="text-sm opacity-90">Total Erlangga</p>
                            <p className="text-2xl font-bold">
                                {summaryData.total_erlangga_formatted || "Rp 0"}
                            </p>
                        </div>
                        <div>
                            <p className="text-sm opacity-90">Tagihan 2%</p>
                            <p className="text-2xl font-bold">
                                {summaryData.tagihan_2persen_formatted || "Rp 0"}
                            </p>
                        </div>
                    </div>
                ) : (
                            ...
                            {data.data.map((cabang) => (
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        onClick={() =>
                                            toggleCabangExpand(cabang.cabang_id)
                                        }
                                    >
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-600">
                                                        Total Orders:{" "}
                                                        {cabang.cabang_totals.order_count}
                                                        {cabang.cabang_totals
                                                            .order_count_shown &&
